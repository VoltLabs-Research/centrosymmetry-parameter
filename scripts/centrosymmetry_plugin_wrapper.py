...
BINARY_NAME = "centrosymmetry"
PLUGIN_REPO_DIRNAME = "CentroSymmetryParameter"
ENV_BINARY_OVERRIDE = "VOLT_CENTROSYMMETRY_BINARY"
REQUIRED_OUTPUTS = ["_centrosymmetry.msgpack", "_atoms.msgpack"]
LOG_TAG = "centrosymmetry-plugin"
